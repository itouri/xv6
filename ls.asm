...
fmtname(char *path)
{
  ...
  93:	05 ec 0a 00 00       	add    $0xaec,%eax
  ...
  return buf;
  a7:	b8 ec 0a 00 00       	mov    $0xaec,%eax
}
...
ls(char *path)
{
  ...
  dc:	68 84 0a 00 00       	push   $0xa84
  e1:	6a 02                	push   $0x2
  e3:	e8 f3 05 00 00       	call   6db <printf>
 ...
 10f:	68 98 0a 00 00       	push   $0xa98
 114:	6a 02                	push   $0x2
 116:	e8 c0 05 00 00       	call   6db <printf>
 ...
 16e:	53                   	push   %ebx
 16f:	50                   	push   %eax
 170:	68 ac 0a 00 00       	push   $0xaac
 175:	6a 01                	push   $0x1
 177:	e8 5f 05 00 00       	call   6db <printf>
 ...
 19f:	68 b9 0a 00 00       	push   $0xab9
 1a4:	6a 01                	push   $0x1
 1a6:	e8 30 05 00 00       	call   6db <printf>
 ...
 24c:	50                   	push   %eax
 24d:	68 98 0a 00 00       	push   $0xa98
 252:	6a 01                	push   $0x1
 254:	e8 82 04 00 00       	call   6db <printf>
 ...
 28a:	53                   	push   %ebx
 28b:	50                   	push   %eax
 28c:	68 ac 0a 00 00       	push   $0xaac
 291:	6a 01                	push   $0x1
 293:	e8 43 04 00 00       	call   6db <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 674:	8a 90 d8 0a 00 00    	mov    0xad8(%eax),%dl
 ...
 6a3:	74 2a                	je     6cf <printint+0xa1>
    buf[i++] = '-';
 ...
 6ae:	ff 45 f4             	incl   -0xc(%ebp)
  ...
  while(--i >= 0)
 6b1:	eb 1d                	jmp    6d0 <printint+0xa2>
    putc(fd, buf[i]);
 ...
 6cd:	eb 01                	jmp    6d0 <printint+0xa2>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 6cf:	90                   	nop
 6d0:	ff 4d f4             	decl   -0xc(%ebp)
 6d3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 6d7:	79 da                	jns    6b3 <printint+0x85>
    putc(fd, buf[i]);
}
 6d9:	c9                   	leave  
 6da:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 6f8:	e9 58 01 00 00       	jmp    855 <printf+0x17a>
    c = fmt[i] & 0xff;
 ...
 738:	e8 cf fe ff ff       	call   60c <putc>
 ...
 762:	e8 c7 fe ff ff       	call   62e <printint>
 ...
 78c:	e8 9d fe ff ff       	call   62e <printint>
 ...
 7b3:	75 25                	jne    7da <printf+0xff>
          s = "(null)";
 7b5:	c7 45 f4 ce 0a 00 00 	movl   $0xace,-0xc(%ebp)
        while(*s != 0){
 7bc:	eb 1d                	jmp    7db <printf+0x100>
          putc(fd, *s);
 ...
 7cd:	e8 3a fe ff ff       	call   60c <putc>
 7d2:	83 c4 10             	add    $0x10,%esp
          s++;
 7d5:	ff 45 f4             	incl   -0xc(%ebp)
 7d8:	eb 01                	jmp    7db <printf+0x100>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 7fb:	e8 0c fe ff ff       	call   60c <putc>
 ...
 81c:	e8 eb fd ff ff       	call   60c <putc>
 ...
 82e:	e8 d9 fd ff ff       	call   60c <putc>
 ...
 843:	e8 c4 fd ff ff       	call   60c <putc>
 ...
 84b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 852:	ff 45 f0             	incl   -0x10(%ebp)
 855:	8b 55 0c             	mov    0xc(%ebp),%edx
 858:	8b 45 f0             	mov    -0x10(%ebp),%eax
 85b:	8d 04 02             	lea    (%edx,%eax,1),%eax
 85e:	8a 00                	mov    (%eax),%al
 860:	84 c0                	test   %al,%al
 862:	0f 85 95 fe ff ff    	jne    6fd <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 87b:	a1 04 0b 00 00       	mov    0xb04,%eax
...
free(void *ap)
{
 ...
 909:	03 45 fc             	add    -0x4(%ebp),%eax
 90c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 90f:	75 20                	jne    931 <free+0xc5>
    p->s.size += bp->s.size;
 ...
 92f:	eb 08                	jmp    939 <free+0xcd>
  } else
    p->s.ptr = bp;
 931:	8b 45 fc             	mov    -0x4(%ebp),%eax
 934:	8b 55 f8             	mov    -0x8(%ebp),%edx
 937:	89 10                	mov    %edx,(%eax)
  freep = p;
 939:	8b 45 fc             	mov    -0x4(%ebp),%eax
 93c:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 941:	c9                   	leave  
 942:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 962:	50                   	push   %eax
 963:	e8 8c fc ff ff       	call   5f4 <sbrk>
 ...
 993:	50                   	push   %eax
 994:	e8 d3 fe ff ff       	call   86c <free>
 999:	83 c4 10             	add    $0x10,%esp
  return freep;
 99c:	a1 04 0b 00 00       	mov    0xb04,%eax
}
 9a1:	c9                   	leave  
 9a2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 9b2:	40                   	inc    %eax
 9b3:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 9b6:	a1 04 0b 00 00       	mov    0xb04,%eax
 9bb:	89 45 f0             	mov    %eax,-0x10(%ebp)
 9be:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 9c2:	75 23                	jne    9e7 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 9c4:	c7 45 f0 fc 0a 00 00 	movl   $0xafc,-0x10(%ebp)
 9cb:	8b 45 f0             	mov    -0x10(%ebp),%eax
 9ce:	a3 04 0b 00 00       	mov    %eax,0xb04
 9d3:	a1 04 0b 00 00       	mov    0xb04,%eax
 9d8:	a3 fc 0a 00 00       	mov    %eax,0xafc
    base.s.size = 0;
 9dd:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 9e4:	00 00 00 
  }
 ...
 a7d:	e9 6d ff ff ff       	jmp    9ef <malloc+0x4c>
}
 a82:	c9                   	leave  
 a83:	c3                   	ret    
