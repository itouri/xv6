...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c0:	8a 90 0c 08 00 00    	mov    0x80c(%eax),%dl
...
printf(int fd, char *fmt, ...)
{
 ...
 4ff:	75 25                	jne    526 <printf+0xff>
          s = "(null)";
 501:	c7 45 f4 03 08 00 00 	movl   $0x803,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c7:	a1 28 08 00 00       	mov    0x828,%eax
...
free(void *ap)
{
 ...
 688:	a3 28 08 00 00       	mov    %eax,0x828
}
 68d:	c9                   	leave  
 68e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6e5:	83 c4 10             	add    $0x10,%esp
  return freep;
 6e8:	a1 28 08 00 00       	mov    0x828,%eax
}
 6ed:	c9                   	leave  
 6ee:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 6ff:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 702:	a1 28 08 00 00       	mov    0x828,%eax
 707:	89 45 f0             	mov    %eax,-0x10(%ebp)
 70a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 70e:	75 23                	jne    733 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 710:	c7 45 f0 20 08 00 00 	movl   $0x820,-0x10(%ebp)
 717:	8b 45 f0             	mov    -0x10(%ebp),%eax
 71a:	a3 28 08 00 00       	mov    %eax,0x828
 71f:	a1 28 08 00 00       	mov    0x828,%eax
 724:	a3 20 08 00 00       	mov    %eax,0x820
    base.s.size = 0;
 729:	c7 05 24 08 00 00 00 	movl   $0x0,0x824
 730:	00 00 00 
  }
 ...
 786:	a3 28 08 00 00       	mov    %eax,0x828
      return (void*)(p + 1);
 ...
 791:	eb 3b                	jmp    7ce <malloc+0xdf>
    ...
    if(p == freep)
 793:	a1 28 08 00 00       	mov    0x828,%eax
